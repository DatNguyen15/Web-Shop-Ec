...
router.post("/add-click", productController.postAddClicking);
//router.get("/get-userclick", productController.getProductClickByUser);
//router.get("/get-click", productController.getProductClick);
router.get("/get-click/:uId", productController.getProductClickByUser);
